...
// server build replaces this compiled shim with the package's built distribution so
// published server installs do not need a separate paperclip-runner npm bootstrap.
