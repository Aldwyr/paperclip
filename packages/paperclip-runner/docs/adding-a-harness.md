...
| ACPX (Pi, Claude, Codex) | `acpxPermissionMode` | `approve-all`, `approve-reads`, `deny-all` | `approve-all` |
| Claude Managed | none | provider-managed | maximum supported |
| AWS AgentCore | none | provider-managed | maximum supported |
