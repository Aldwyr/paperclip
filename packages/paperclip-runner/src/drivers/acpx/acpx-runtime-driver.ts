...
function displayAgent(agent: QualifiedAcpxAgent): string {
  return agent === "pi" ? "Pi" : agent === "claude" ? "Claude" : "Codex";
}

function biller(agent: QualifiedAcpxAgent): "openrouter" | "anthropic" | "openai" {
  return agent === "pi" ? "openrouter" : agent === "claude" ? "anthropic" : "openai";
}
