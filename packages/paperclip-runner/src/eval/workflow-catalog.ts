...
/** The twelve composed workflows distilled from the six-hour stress campaign. */
export const RUNNER_WORKFLOW_CATALOG: readonly RunnerWorkflowEvalCase[] = Object.freeze([
  workflow({
    ...
    lanes: ["deterministic", "live"], tags: ["response", "resolver", "long-output"], coreLiveRepeat: true,
  ...
  workflow({
    ...
    lanes: ["deterministic", "live"], tags: ["activity", "tools", "search"], coreLiveRepeat: true,
  ...
  workflow({
    ...
    lanes: ["deterministic", "live"], tags: ["verification", "caveat", "review"], coreLiveRepeat: false,
    providers: [...ALL_PROVIDERS], steps: [{ kind: "run_start", taskMode: "execute" }],
    assertions: {
  ...
  workflow({
    ...
    lanes: ["deterministic", "live"], tags: ["interaction", "wait", "continuation"], coreLiveRepeat: true,
  ...
  workflow({
    ...
    lanes: ["deterministic", "live"], tags: ["steering", "ordering", "idempotency"], coreLiveRepeat: false,
    providers: [...ALL_PROVIDERS],
    steps: [
  ...
  workflow({
    ...
    lanes: ["deterministic", "live"], tags: ["review", "ownership", "narrow-repair"], coreLiveRepeat: false,
    providers: [...ALL_PROVIDERS],
    steps: [
      { kind: "run_start", taskMode: "execute" },
      { kind: "review_decision", decision: "reject" },
  ...
  workflow({
    ...
    lanes: ["deterministic", "live", "chaos"], tags: ["completion", "schema", "exhaustion"], coreLiveRepeat: true,
    providers: [...ALL_PROVIDERS], steps: [{ kind: "run_start", taskMode: "execute" }],
    assertions: {
  ...
  workflow({
    ...
    lanes: ["deterministic", "live", "chaos"], tags: ["restart", "checkpoint", "authority"], coreLiveRepeat: false,
    providers: [...ALL_PROVIDERS],
    steps: [
      { kind: "run_start", taskMode: "execute" },
  ...
  workflow({
    ...
    lanes: ["deterministic", "live", "chaos"], tags: ["cancellation", "permission", "interruption"], coreLiveRepeat: false,
    providers: [...ALL_PROVIDERS],
    steps: [
      { kind: "run_start", taskMode: "execute" },
  ...
  workflow({
    ...
    lanes: ["deterministic", "live", "chaos"], tags: ["trace", "lineage", "redaction"], coreLiveRepeat: false,
    providers: [...ALL_PROVIDERS], steps: [{ kind: "run_start", taskMode: "execute" }],
    assertions: {
      issueStatus: "done", runStatus: "succeeded", semanticDisposition: "done",
