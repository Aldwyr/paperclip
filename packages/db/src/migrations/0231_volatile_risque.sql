ALTER TABLE "connection_grants" ADD COLUMN "external_credential" jsonb;--> statement-breakpoint
ALTER TABLE "tool_connections" ADD COLUMN "credential_source" text DEFAULT 'paperclip_vault' NOT NULL;--> statement-breakpoint
ALTER TABLE "tool_connections" ADD COLUMN "external_credential" jsonb;--> statement-breakpoint
